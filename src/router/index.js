    ...
    routes: [
        ...
        },
        {
            ...
            children: [
                ...
                {
                    path: '/goldChangeLogPage',
                    component: () => import(/* webpackChunkName: "icon" */ '../components/page/goldChangeLogPage.vue'),
                    meta: { title: '金币明细列表' }
                },
                {
                ...
                {
                    path: '/partnerGroupOrderPage',
                    component: () => import(/* webpackChunkName: "table" */ '../components/page/partnerGroupOrderPage.vue'),
                    meta: { title: '商户拼团订单' }
                },
                {
                    path: '/404',
