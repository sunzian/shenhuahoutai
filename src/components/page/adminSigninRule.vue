        ...
        <div class="container">
            ...
            <el-form ref="form1" :model="form1">
                ...
                <el-form-item :required="true" label="签到规则说明" :label-width="formLabelWidth">
                    <el-input style="width: 250px;" readonly type="textarea" maxlength="50" show-word-limit v-model="form1.oSignTips" autocomplete="off"></el-input>
                </el-form-item>
            </el-form>
            <el-table
                    :data="tableData"
        ...
        methods: {
            ...
            getMenu() {
                ...
                setTimeout(() => {
                    ...
                    jsonArr.push({ key: 'sign', value: sign });
                    var params = ParamsAppend(jsonArr);
                    https.fetchPost('/admin/signinRule/signinRulePage',params).then(data => {
                        loading.close();
                        if (data.data.code == 'success') {
