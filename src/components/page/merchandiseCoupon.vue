        ...
        <el-dialog :close-on-click-modal="false" title="新增" :visible.sync="dialogFormVisible">
            <el-form :model="oForm">
                <el-form-item :required="true" label="优惠券名称：" :label-width="formLabelWidth">
                    <el-input placeholder="限15个字" style="width: 250px" maxlength="15" v-model="oForm.name"
                ...
                <el-form-item :required="true" v-if="oForm.selectMerchandiseType==1||oForm.selectMerchandiseType==2"
                              label="适用卖品：" :label-width="formLabelWidth">
                ...
                <el-form-item :required="true" v-if="oForm.reduceType == 1" label="固定金额：" :label-width="formLabelWidth">
                    <el-input onkeyup="this.value=this.value.replace(/[^0-9.]+/,'')" placeholder="固定金额购买一件指定的商品"
                              style="width: 250px" v-model="oForm.discountMoney" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item :required="true" v-if="oForm.reduceType==2" label="减免金额：" :label-width="formLabelWidth">
                    满
                    <el-input onkeyup="this.value=this.value.replace(/[^0-9.]+/,'')" placeholder="订单总额满多少减多少"
                              style="width: 250px" v-model="oForm.achieveMoney" autocomplete="off"></el-input>
                    减
                    <el-input onkeyup="this.value=this.value.replace(/[^0-9.]+/,'')" style="width: 150px"
                              v-model="oForm.discountMoney" autocomplete="off"></el-input>
                </el-form-item>
...
4、其他注意事项"
        ...
        <el-dialog :close-on-click-modal="false" title="修改" :visible.sync="editVisible">
            <el-form ref="form" :model="form">
                <el-form-item :required="true" label="优惠券名称：" :label-width="formLabelWidth">
                    <el-input placeholder="限15个字" style="width: 250px" maxlength="15" v-model="oName"
                              autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item :required="true" label="发放方式" :label-width="formLabelWidth">
                ...
                <el-form-item :required="true" v-if="oSelectMerchandiseType==1||oSelectMerchandiseType==2" label="适用卖品："
                ...
                <el-form-item :required="true" v-if="oReduceType == 1" label="固定金额：" :label-width="formLabelWidth">
                    <el-input onkeyup="this.value=this.value.replace(/[^0-9.]+/,'')" placeholder="固定金额购买一件指定的商品"
                              style="width: 250px" v-model="oDiscountMoney" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item :required="true" v-if="oReduceType==2" label="减免金额：" :label-width="formLabelWidth">
                    满
                    <el-input onkeyup="this.value=this.value.replace(/[^0-9.]+/,'')" placeholder="订单总额满多少减多少"
                              style="width: 250px" v-model="oAchieveMoney" autocomplete="off"></el-input>
                    减
                    <el-input onkeyup="this.value=this.value.replace(/[^0-9.]+/,'')" style="width: 150px"
                              v-model="oDiscountMoney" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item :required="true" label="开启状态：" :label-width="formLabelWidth">
