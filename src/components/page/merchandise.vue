        ...
        <el-dialog title="编辑" :visible.sync="editVisible">
            <el-form ref="form" :model="form">
                <el-form-item  label="商品名称" :label-width="formLabelWidth">
                    <el-input style="width: 250px" v-model="form.name" autocomplete="off" :disabled="true"></el-input>
                </el-form-item>
                ...
                <el-form-item label="商品描述" :label-width="formLabelWidth">
                    <el-input style="width: 250px" v-model="form.merchandiseDesc" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item label="零售价" :label-width="formLabelWidth">
                    <el-input style="width: 250px" v-model="form.standardPrice" autocomplete="off" :disabled="true"></el-input>
                </el-form-item>
                <el-form-item label="结算价" :label-width="formLabelWidth">
                    <el-input style="width: 250px" v-model="form.settlePrice" autocomplete="off" :disabled="true"></el-input>
                </el-form-item>
        ...
        methods: {
            ...
            addChange(index, row){//是否修改权限
                ...
                setTimeout(() => {
                    ...
                    jsonArr.push({key:"sign",value:sign});
                    let params = ParamsAppend(jsonArr);
                    https.fetchPost('/merchandise/modifyPage',params).then((data) => {
                        console.log(data);
                        console.log(JSON.parse(Decrypt(data.data.data)));
                        if(data.data.code=='success'){
            ...
            exChanger() {
                ...
                setTimeout(() => {
                    ...
                    https.fetchPost('/merchandise/modify',params).then((data) => {
                        console.log(data);
                        // console.log(JSON.parse(Decrypt(data.data.data)));
                        if(data.data.code=='success'){
            ...
            UserPassword(row){//商品同步
                ...
                setTimeout(() => {
                    ...
                    jsonArr.push({key:"sign",value:sign});
                    var params = ParamsAppend(jsonArr);
                    https.fetchPost('/merchandise/queryMerchandise',params).then((data) => {
                        console.log(data);
                        if(data.data.code=='success') {
                            var oData = JSON.parse(Decrypt(data.data.data));
                            console.log(oData);
