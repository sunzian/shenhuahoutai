                ...
                <el-table-column prop="name" label="图片">
                    <template slot-scope="scope">
                        <el-popover
                            ...
                            <img slot="reference" :src="scope.row.typePic" :alt="scope.row.typePic" style="max-height: 50px;max-width: 130px">
                        </el-popover>
                    </template>
                </el-table-column>
    ...
    export default {
        ...
        methods: {
            addPage(){//获取新增按钮权限
                ...
                setTimeout(() => {
                    https.fetchPost('/merchandiseType/addPage','').then((data) => {
                        console.log(data);
            ...
            addRole(){ //新增按钮操作
                ...
                setTimeout(() => {
                    ...
                    if(this.dialogFormVisible == true){
                        https.fetchPost('/merchandiseType/addMerchandiseType',params).then((data) => {//新增
                            console.log(data);
                            if(data.data.code=='success'){
            ...
            delChange(index, row){//删除数据
                ...
                setTimeout(() => {
                    ...
                    jsonArr.push({key:"sign",value:sign});
                    let params = ParamsAppend(jsonArr);
                    https.fetchPost('/merchandiseType/deleteMerchandiseType',params).then((data) => {
                        // console.log(data);
            ...
            addChange(index, row){//是否修改权限
                ...
                setTimeout(() => {
                    ...
                    jsonArr.push({key:"sign",value:sign});
                    let params = ParamsAppend(jsonArr);
                    https.fetchPost('/merchandiseType/modifyPage',params).then((data) => {
                        console.log(data);
                        console.log(JSON.parse(Decrypt(data.data.data)));
                        if(data.data.code=='success'){
            ...
            exChanger() {
                ...
                setTimeout(() => {
                    ...
                    https.fetchPost('/merchandiseType/modifyMerchandiseType',params).then((data) => {
                        console.log(data);
                        // console.log(JSON.parse(Decrypt(data.data.data)));
                        if(data.data.code=='success'){
            ...
            refresh(){//刷新卖品页面
                ...
                setTimeout(() => {
                    ...
                    jsonArr.push({key:"sign",value:sign});
                    var params = ParamsAppend(jsonArr);
                    https.fetchPost('/merchandiseType/list',params).then((data) => {
                        console.log(data);
                        if(data.data.code=='success') {
                            var oData = JSON.parse(Decrypt(data.data.data));
                            console.log(oData);
