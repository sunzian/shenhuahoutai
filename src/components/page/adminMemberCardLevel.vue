        ...
        methods: {
            ...
            changeStatus(index, row) {
                ...
                this.$confirm('是否确定'+this.rowMess+'此会员卡?', '提示', {
                    ...
                    .then(() => {
                        ...
                        https.fetchPost('/admin/memberCardLevel/modifyCardStatus', params).then(data => {
                            loading.close();
                            console.log(data);
            ...
            addChange(index, row) {
                ...
                setTimeout(() => {
                    ...
                    jsonArr.push({ key: 'sign', value: sign });
                    let params = ParamsAppend(jsonArr);
                    https.fetchPost('/admin/memberCardLevel/modifyPage', params).then(data => {
                            loading.close();
                            console.log(JSON.parse(Decrypt(data.data.data)));
                            if (data.data.code == 'success') {
            ...
            exChanger() {
                ...
                setTimeout(() => {
                    ...
                    let params = ParamsAppend(jsonArr);
                    console.log(params);
                    https.fetchPost('/admin/memberCardLevel/modify', params).then(data => {
                            loading.close();
                            console.log(data);
                            // console.log(JSON.parse(Decrypt(data.data.data)));
                            if (data.data.code == 'success') {
            ...
            Search() {
                ...
                setTimeout(() => {
                    ...
                    https.fetchPost('/admin/memberCardLevel/list', params).then(data => {
                        loading.close();
                        console.log(data);
                        if (data.data.code == 'success') {
            ...
            getMenu() {
                ...
                setTimeout(() => {
                    ...
                    console.log(jsonArr)
                    var params = ParamsAppend(jsonArr);
                    https.fetchPost('/cinema/getCinemaInfoByBusinessCode', params).then(data => {
                            loading.close();
                            if (data.data.code == 'success') {
