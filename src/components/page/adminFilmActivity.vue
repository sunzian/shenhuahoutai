...
export default {
    ...
    methods: {
        ...
        addChange(index, row) {
            ...
            let params = ParamsAppend(jsonArr);
            https
                .fetchPost('/admin/filmDiscountActivity/getTimesById', params)
                .then(data => {
                    //查询可用时间段
                    loading.close();
                    console.log(data);
            ...
            https
                .fetchPost('/admin/filmDiscountActivity/getActivityById', params)
                .then(data => {
                    loading.close();
                    console.log(data);
                    console.log(JSON.parse(Decrypt(data.data.data)));
        ...
        getMenu() {
            ...
            setTimeout(() => {
                ...
                https
                    .fetchPost('/admin/filmDiscountActivity/page', params)
                    .then(data => {
                        loading.close();
                        if (data.data.code == 'success') {
