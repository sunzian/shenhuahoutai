        ...
        derive() {
            ...
            setTimeout(() => {
                ...
                jsonArr.push({
                    key: 'exportKeysJson',
                    value:
                        "['cinemaCode','orderNo','userName','mobile','merNames','totalOriginalPrice','totalActivityDiscount','totalCouponDiscount','totalActualPrice','chPayStatus','chPayWay','payTime','chSubmitStatus','submitTime','chDeliveryType','submitOrderCode','printNo','userCouponName','deliveryAddress','chActivityType','activityName','tradeNo','deliveryMemo','chCancelStatus','refundReason','refundTime','submitMessage']"
                });
                jsonArr.push({
                    key: 'exportTitlesJson',
                    value:
                        "['影院编码','本地单号','用户','手机号','卖品内容','总原价','活动优惠金额','优惠券优惠金额','实付金额','支付状态','支付方式','支付时间','下单状态','下单时间','取货方式','系统单号','取货码','优惠券名称','送货地址','活动类型','活动名称','支付交易号','备注','退卖品状态','退款原因','退款时间','下单失败原因']"
                });
