    ...
    <div>
        ...
        <div class="container">
            <div class="handle-box">
                ...
                <el-button style="margin-top: 10px;margin-left: 10px;width: 90px;" type="primary" icon="el-icon-search" @click="Search">搜索</el-button>
            </div>
            <el-form v-model="oForm">
                <el-form-item :required="true" label="邀请注册获得金币数量" :label-width="formLabelWidth">
                    <el-input disabled onkeyup="this.value=this.value.replace(/\D/g,'')" style="width: 250px" v-model="oForm.miniRegisterNumber" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item :required="true" label="1积分兑换"  :label-width="formLabelWidth">
                    <el-input disabled onkeyup="this.value=this.value.replace(/\D/g,'')" style="width: 250px" v-model="oForm.pointChangePercent" autocomplete="off"></el-input>金币
                </el-form-item>
            </el-form>
        ...
        methods: {
            ...
            getMenu(){//获取菜单栏
                ...
                setTimeout(() => {
                    ...
                    https.fetchPost('/admin/goldAcquireRule/page',params).then((data) => {
                        loading.close();
                        console.log(data);
                        if (data.data.code == 'success') {
