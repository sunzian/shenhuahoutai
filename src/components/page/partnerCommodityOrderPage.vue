        ...
        methods: {
            ...
            addChange(index, row) {
                ...
                setTimeout(() => {
                    ...
                    https
                        .fetchPost('/cinemaPartner/getGoldCommodityById', params)
                        .then(data => {
                            loading.close();
                            if (data.data.code == 'success') {
            ...
            getMenu() {
                ...
                setTimeout(() => {
                    ...
                    var params = ParamsAppend(jsonArr);
                    https
                        .fetchPost('/cinemaPartner/goldCommodityOrderPage', params)
                        .then(data => {
                            loading.close();
                            if (data.data.code == 'success') {
