            ...
            derive() {
                ...
                setTimeout(() => {
                    ...
                    jsonArr.push({
                        ...
                        value:
                            '[\'影院名称\',\'商户名称\',\'商户订单结算状态\',\'订单号\',\'手机号\',\'用户备注\',\'商品名称\',\'消费金币\',\'支付金额\',\'领取时间\',\'兑换时间\',\'兑换状态\',\'取货方式\',\'物流单号\',\'快递状态\',\'收货人名称\',\'收货人电话\',\'省\',\'市\',\'区\',\'收货人地址\',\'支付交易号\',\'支付回调消息\',\'兑换方式\',\'核销状态\',\'退款状态\',\'订单类型\',\'退款交易号\',\'退款原因\',\'微信退款回复\',\'退款时间\',\'退款金额\']'
                    });
