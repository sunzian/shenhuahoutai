    ...
    export default {
        ...
        methods: {
            ...
            addChange(index, row) {
                ...
                let params = ParamsAppend(jsonArr);
                https
                    .fetchPost('/admin/secondKillActivity/updatePage', params)
                    .then(data => {
                        loading.close();
                        if (data.data.code == 'success') {
            ...
            getMenu() {
                ...
                jsonArr.push({ key: 'cinemaCodes', value: this.query.cinemaCode });
                ...
                var params = ParamsAppend(jsonArr);
                https
                    .fetchPost('/admin/secondKillActivity/page', params)
                    .then(data => {
                        loading.close();
                        if (data.data.code == 'success') {
