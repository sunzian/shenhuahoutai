    ...
    <div>
        ...
        <el-dialog :close-on-click-modal="false" title="新增" :visible.sync="dialogFormVisible">
            <el-form :model="oForm">
                ...
                <el-form-item
                        ...
                        :label-width="formLabelWidth"
                >
                    <el-input placeholder="请输入正确的的数字" style="width: 150px" v-model="oForm.effectiveDuration " autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item
                        :required="true"
                        label="成团人数"
                        :label-width="formLabelWidth"
                >
                    <el-input placeholder="请输入正确的的数字" style="width: 150px" v-model="oForm.agglomerationNumber " autocomplete="off"></el-input>
                </el-form-item>
                ...
                <el-form-item
                        ...
                        :label-width="formLabelWidth"
                >
                    <el-input placeholder="请输入正确的的数字" style="width: 150px" v-model="oForm.purchaseGroupNum " autocomplete="off"></el-input>
                </el-form-item>
        ...
        <el-dialog :close-on-click-modal="false" title="修改" :visible.sync="editVisible">
            <el-form ref="form" :model="form">
                <el-form-item :required="true" label="通用方式" :label-width="formLabelWidth">
                    <el-radio-group v-model="oCommonType" @change="selectCinema" :disabled="isCanUpdate==2">
                        <el-radio :label="1">全部影院</el-radio>
                        <el-radio :label="2">指定影院</el-radio>
                    </el-radio-group>
                </el-form-item>
                <el-form-item
                 ...
                 >
                    <el-checkbox-group v-model="oMerchandiseCode" @change="selectGoods" :disabled="isCanUpdate==2">
                        <el-checkbox
                                v-for="item in goodsInfo"
                                :label="item.merchandiseCode"
                                :key="item.merchandiseCode"
                ...
                <el-form-item
                        ...
                        :label-width="formLabelWidth"
                >
                    <el-input placeholder="请输入正确的的数字" :disabled="isCanUpdate==2" style="width: 150px" v-model="oEffectiveDuration " autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item
                        :required="true"
                        label="成团人数"
                        :label-width="formLabelWidth"
                >
                    <el-input placeholder="请输入正确的的数字" :disabled="isCanUpdate==2" style="width: 150px" v-model="oAgglomerationNumber " autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item :required="true" label="是否限制用户开团次数" :label-width="formLabelWidth">
                    <el-select v-model="oPurchaseGroup" placeholder="请选择" :disabled="isCanUpdate==2">
                        <el-option
                                v-for="item in canUse1"
                                :key="item.value"
                                :label="item.label"
                ...
                <el-form-item
                        ...
                        :label-width="formLabelWidth"
                >
                    <el-input placeholder="请输入正确的的数字" :disabled="isCanUpdate==2" style="width: 150px" v-model="oPurchaseGroupNum " autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item :required="true" label="是否限制用户购买数量" :label-width="formLabelWidth">
                ...
                <el-form-item
                        ...
                        :label-width="formLabelWidth"
                >
                    <el-input placeholder="请输入正确的的数字" :disabled="isCanUpdate==2" style="width: 150px" v-model="oPurchaseCount " autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item
                        :required="true"
                        label="选择商品"
                ...
                <el-form-item :required="true" label="兑换方式" :label-width="formLabelWidth">
                    <el-select v-model="oChangeType" placeholder="请选择兑换方式" :disabled="isCanUpdate==2">
                        <el-option
                                v-for="item in showType"
                                :key="item.value"
                                :label="item.label"
                ...
                <el-form-item :required="true" label="团购商品数量" :label-width="formLabelWidth">
                    <el-input
                            show-word-limit
                            style="width: 150px"
    ...
    export default {
        ...
        methods: {
            ...
            getMenu() {
                ...
                var params = ParamsAppend(jsonArr);
                https
                    .fetchPost('/groupActivity/page', params)
                    .then(data => {
                        loading.close();
                        if (data.data.code == 'success') {
