            ...
            >
                ...
                <el-table-column prop="sort" label="满多少张数减" width="120">
                    <template
                        ...
                        slot-scope="scope"
                    >{{scope.row.achieveMoney}}/{{scope.row.discountMoney}}</template>
                </el-table-column>
        ...
        <el-dialog title="新增" :close-on-click-modal="false" :visible.sync="dialogFormVisible">
            <el-form :model="oForm">
                ...
                <el-form-item
                    ...
                    label="增减金额"
                    :label-width="formLabelWidth"
                    v-if="oForm.reduceType == 5"
                >
                    <el-input
                        placeholder="（最低票价+-金额）*张数"
                        style="width: 250px"
                        v-model="oForm.discountMoney"
                        autocomplete="off"
                    ></el-input>&nbsp;&nbsp;
...
4、其他注意事项"
        ...
        <el-dialog title="修改" :close-on-click-modal="false" :visible.sync="editVisible">
            <el-form ref="form" :model="form">
                ...
                <el-form-item label="加价规则" :label-width="formLabelWidth" v-if="oReduceType == 1">
                    当影票最低票价大于
                    <el-input
                        style="width: 50px"
                ...
                >
                    ...
                    <el-input
                        ...
                        autocomplete="off"
                    ></el-input>&nbsp;张&nbsp;&nbsp;减&nbsp;
                    <el-input style="width: 150px" v-model="oDiscountMoney" autocomplete="off"></el-input>&nbsp;元
                </el-form-item>
                <el-form-item
                    label="减免金额"
                    :label-width="formLabelWidth"
