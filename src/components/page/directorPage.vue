    ...
    <div>
        <div class="crumbs">
            <el-breadcrumb separator="/">
                <el-breadcrumb-item>
                    <i class="el-icon-lx-cascades"></i> 导演管理
                </el-breadcrumb-item>
            </el-breadcrumb>
        </div>
        <div class="container">
            <div class="handle-box">
                <el-input v-model="query.name" placeholder="导演名称" class="handle-input mr10"></el-input>
            ...
            <el-form :model="oForm">
                ...
                <el-form-item label="导演图片" :label-width="formLabelWidth">
                    ...
                    >
                        ...
                        <div class="el-upload__tip" slot="tip">只能上传jpg/png文件，且不超过500kb 建议70*100</div>
                    </el-upload>
                    <el-popover placement="right" title trigger="hover">
            ...
            <el-form ref="form" :model="form">
                ...
                <el-form-item label="图片地址" :label-width="formLabelWidth">
                    ...
                    >
                        ...
                        <div slot="tip" class="el-upload__tip">只能上传jpg/png文件，且不超过500kb 建议70*100</div>
                        </el-upload>
                </el-form-item>
            </el-form>
