    ...
    export default {
        ...
        methods: {
            ...
            addChange(index, row) {
                ...
                jsonArr.push({ key: 'sign', value: sign });
                let params = ParamsAppend(jsonArr);
                https.fetchPost('/admin/filmDiscountActivity/getTimesById', params).then(data => { //查询可用时间段
                    loading.close();
                    console.log(data);
                    this.dateInfo=[];
                    this.startArr=[];
                ...
                https.fetchPost('/admin/merchandiseDiscountActivity/getActivityById', params).then(data => {
                    loading.close();
                    if (data.data.code == 'success') {
            ...
            getMenu() {
                ...
                https.fetchPost('/admin/merchandiseDiscountActivity/page', params).then(data => {
                    loading.close();
                    if (data.data.code == 'success') {
