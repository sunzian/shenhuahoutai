        ...
        <el-dialog :close-on-click-modal="false" title="新增" :visible.sync="dialogFormVisible">
            <el-form :model="oForm">
                ...
                <el-form-item
                    :required="true"
                    label="活动总张数："
                    v-if="oForm.oCanNum==1&&(oForm.reduceType!=2)"
                    :label-width="formLabelWidth"
                >
                ...
                <el-form-item
                    :required="true"
                    label="限购时间："
                    v-if="oForm.oneCanNum==1&&(oForm.reduceType!=2)"
                    :label-width="formLabelWidth"
                >
        ...
        <el-dialog :close-on-click-modal="false" title="详情" :visible.sync="editVisible">
            <el-form ref="form" :model="form">
                ...
                <el-form-item
                    :required="true"
                    label="活动总张数："
                    v-if="oIsLimitTotal==1&&(oReduceType!=2)"
                    :label-width="formLabelWidth"
                >
                ...
                <el-form-item
                    :required="true"
                    label="限购时间："
                    v-if="oIsLimitSingle==1&&(oReduceType!=2)"
                    :label-width="formLabelWidth"
                >
...
export default {
    ...
    methods: {
        ...
        addPage() {
            ...
            https
                .fetchPost('/merchandiseDiscountActivity/addPage', '')
                .then(data => {
                    loading.close();
                    console.log(data);
        ...
        addRole() {
            ...
            if (this.dialogFormVisible == true) {
                https
                    .fetchPost('/merchandiseDiscountActivity/addActivity', params)
                    .then(data => {
                        //新增
                        loading.close();
                        console.log(data);
        ...
        delChange(index, row) {
            ...
            this.$confirm('此操作将永久删除该文件, 是否继续?', '提示', {
                ...
                .then(() => {
                    ...
                    let params = ParamsAppend(jsonArr);
                    https
                        .fetchPost('/merchandiseDiscountActivity/deleteById', params)
                        .then(data => {
                            if (data.data.code == 'success') {
        ...
        addChange(index, row) {
            ...
            https
                .fetchPost('/admin/merchandiseDiscountActivity/getActivityById', params)
                .then(data => {
                    loading.close();
                    if (data.data.code == 'success') {
        ...
        exChanger() {
            ...
            let params = ParamsAppend(jsonArr);
            https
                .fetchPost('merchandiseDiscountActivity/updateById', params)
                .then(data => {
                    loading.close();
                    // console.log(JSON.parse(Decrypt(data.data.data)));
                    if (data.data.code == 'success') {
        ...
        changeStatus(index, row) {
            ...
            this.$confirm('是否确定' + this.rowMess + '此活动?', '提示', {
                ...
                .then(() => {
                    ...
                    let params = ParamsAppend(jsonArr);
                    https
                        .fetchPost('/merchandiseDiscountActivity/updateStatusById', params)
                        .then(data => {
                            loading.close();
                            console.log(data);
                            // console.log(JSON.parse(Decrypt(data.data.data)));
        ...
        getMenu() {
            ...
            setTimeout(() => {
                ...
                https
                    .fetchPost('/admin/merchandiseDiscountActivity/page', params)
                    .then(data => {
                        loading.close();
                        if (data.data.code == 'success') {
