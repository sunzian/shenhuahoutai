    ...
    <div>
        ...
        <el-dialog title="新增商品" :visible.sync="dialogFormVisible">
            <el-form v-model="oForm">
                ...
                <el-form-item v-if="oForm.commodity_type==1"  label="商品名称" :label-width="formLabelWidth">
                    <el-input style="width: 250px" v-model="oForm.name" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item v-if="oForm.commodity_type==1"  label="商品图片" :label-width="formLabelWidth">
                    <el-upload
                ...
                <el-form-item v-if="oForm.change_type==1||oForm.change_type==3"  label="所需金币数量" :label-width="formLabelWidth">
                    <el-input style="width: 250px" v-model="oForm.gold" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item v-if="oForm.change_type==2||oForm.change_type==3"  label="所需RMB" :label-width="formLabelWidth">
                ...
                <el-form-item v-if="oForm.assign_type==1" label="选择指定日期" :label-width="formLabelWidth">
                    <el-date-picker
                ...
                <el-form-item v-if="oForm.assign_type==2" label="输入每月几号" :label-width="formLabelWidth">
                    <el-input style="width: 250px" v-model="oForm.assign_info" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item v-if="oForm.assign_type==3" label="输入每月第几周" :label-width="formLabelWidth">
                    <el-input style="width: 250px" v-model="oForm.assign_info" autocomplete="off"></el-input>
                </el-form-item>
                <el-form-item v-if="oForm.assign_type==4" label="输入每周几" :label-width="formLabelWidth">
                    <el-input style="width: 250px" v-model="oForm.assign_info" autocomplete="off"></el-input>
                </el-form-item>
                ...
                <el-form-item v-if="oForm.limit_type==1||oForm.limit_type==2||oForm.limit_type==3" label="对应上方的限制兑换数量" :label-width="formLabelWidth">
