    ...
    <div>
        ...
        <div class="container">
            <div class="handle-box">
                ...
                <el-select filterable clearable v-model="query.recommendedCinemaName" @change="changeSearchCinema" placeholder="推荐人所在影院" class="mr10">
                    <el-option
    ...
    methods: {
        ...
        getMenu() {
            ...
            setTimeout(() => {
                ...
                https
                    .fetchPost('/admin/userShareRegisterRecord/userShareRegisterRecordPage', params)
                    .then(data => {
                        loading.close();
                        if (data.data.code == 'success') {
